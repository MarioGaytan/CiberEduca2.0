...
export const MedalDefinitionSchema =
  SchemaFactory.createForClass(MedalDefinition);
...
export const AvatarOptionDefinitionSchema = SchemaFactory.createForClass(
...
export const GamificationConfigSchema =
  SchemaFactory.createForClass(GamificationConfig);
...
export const DEFAULT_MEDALS: Omit<MedalDefinition, 'isActive' | 'sortOrder'>[] =
  [
    ...
    },
    {
      id: 'workshop_1',
      name: 'Explorador',
      description: 'Completa tu primer taller',
      icon: 'Compass',
      iconType: 'lucide',
      iconColor: '#34d399',
      bgColor: '#34d39920',
      xpReward: 50,
      conditionType: 'workshops_completed',
      conditionValue: 1,
    },
    {
      id: 'workshop_5',
      name: 'Aventurero',
      description: 'Completa 5 talleres',
      icon: 'Star',
      iconType: 'lucide',
      iconColor: '#fbbf24',
      bgColor: '#fbbf2420',
    ...
    },
    {
      id: 'workshop_10',
      name: 'Dedicado',
      description: 'Completa 10 talleres',
      icon: 'Sparkles',
      iconType: 'lucide',
      iconColor: '#f59e0b',
      bgColor: '#f59e0b20',
    ...
    },
    {
      id: 'workshop_25',
      name: 'Maestro',
      description: 'Completa 25 talleres',
      icon: 'Crown',
      iconType: 'lucide',
      iconColor: '#eab308',
      bgColor: '#eab30820',
    ...
    },
    {
      id: 'perfect_1',
      name: 'Perfección',
      description: 'Obtén 100% en un test',
      icon: 'Gem',
      iconType: 'lucide',
      iconColor: '#22d3ee',
      bgColor: '#22d3ee20',
    ...
    },
    {
      id: 'perfect_10',
      name: 'Genio',
      description: 'Obtén 100% en 10 tests',
      icon: 'Brain',
      iconType: 'lucide',
      iconColor: '#ec4899',
      bgColor: '#ec489920',
    ...
    },
    {
      ...
      bgColor: '#a3a3a320',
      xpReward: 100,
      conditionType: 'ranking_position',
      conditionValue: 10,
    ...
    },
    {
      id: 'first_place',
      name: 'Campeón',
      description: 'Alcanza el primer lugar',
      icon: 'Trophy',
      iconType: 'lucide',
      iconColor: '#fbbf24',
      bgColor: '#fbbf2420',
...
export const DEFAULT_AVATAR_OPTIONS: Omit<
  AvatarOptionDefinition,
  'isActive' | 'sortOrder'
>[] = [
  ...
  // Largos (típicamente femeninos)
  {
    ...
    displayName: 'Largo Lacio',
    requiredXp: 0,
    requiredLevel: 0,
  },
  {
    id: 'hair_long_straight2',
    category: 'top',
    value: 'longHairStraight2',
    displayName: 'Largo Lacio 2',
    requiredXp: 0,
    requiredLevel: 0,
  },
  {
  ...
  },
  {
    ...
    displayName: 'Lentes Cuadrados',
    requiredXp: 200,
    requiredLevel: 3,
  },
  {
    id: 'acc_glasses_wayfarers',
    category: 'accessories',
    value: 'wayfarers',
